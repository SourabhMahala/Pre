...
PICS = (environ.get('PICS', 'https://graph.org/file/76777b2988cd8ee5d3bfa-467bd899fa6bb2021c.jpg')).split()
...
QR_CODE = environ.get('QR_CODE', 'https://graph.org/file/afe52acecc5d10bfc537d-9ecce7218d47a1ec5c.jpg') # Scanner Code image 
...
premium = environ.get('PREMIUM_LOGS', '-1002260377151')
...
OWNER_USER_NAME = environ.get("OWNER_USER_NAME", "Sourabh_Mahala") # widout 👉 @
...
STREAM_API = (environ.get('STREAM_API', '/login 7565b54ead36267a2a570fe3ab7f4fd39ebe5450'))
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/Movies_Kingston')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/ALL_M0VIES_ZONE')
MSG_ALRT = environ.get('MSG_ALRT', 'Wʜᴀᴛ Aʀᴇ Yᴏᴜ Lᴏᴏᴋɪɴɢ Aᴛ ?')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', -1002404921667))
GROUP_VERIFY_LOGS = int(environ.get('GROUP_VERIFY_LOGS', -1002404921667)) # Group verify stats 
REQ_CHANNEL = int(environ.get('REQ_CHANNEL', -1002404921667)) # movies request channel, else log channel
